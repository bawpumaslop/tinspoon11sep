...
<title>The Tin Spoon &mdash; Chef Recipe Kits Shipped Chilled</title>
<meta name="description" content="The Tin Spoon ships chef recipe kits with weighed ingredients and a method card. Free delivery over $70, ships chilled from Portland, Maine.">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Alegreya:ital,wght@0,400;0,600;1,400&family=Inter:wght@300;400;500;600&display=swap" rel="stylesheet">
<style>
:root{
  --ink:#161d22; --ink-soft:#566068; --paper:#fdfeff; --tint:#ebf1f4;
  --line:#d6e0e6; --accent:#2a5c7a; --gold:#b08423; --ok:#2f6b46;
  --serif:'Alegreya',Georgia,serif; --sans:'Inter',system-ui,sans-serif;
}
...
header{position:sticky;top:0;z-index:60;background:rgba(253,254,255,.95);backdrop-filter:blur(10px);border-bottom:1px solid var(--line)}
.bar{display:flex;align-items:center;gap:28px;height:66px}
.brand{font-family:var(--serif);font-size:21px;font-weight:600;letter-spacing:.06em;line-height:1}
...
.hero-art{position:relative;overflow:hidden;background:#e0e9ef;min-height:460px}
...
footer{background:var(--ink);color:#e2eaee;padding:64px 0 30px;font-size:14.5px}
...
<div class="ticker"><div><span>Free delivery over $70</span><span>SPOON15 &mdash; 15% off orders over $75</span><span>Ships Mon&ndash;Thu, chilled</span><span>Packed in Portland, Maine</span><span>Free delivery over $70</span><span>SPOON15 &mdash; 15% off orders over $75</span><span>Ships Mon&ndash;Thu, chilled</span><span>Packed in Portland, Maine</span></div></div>

<header>
  <div class="shell bar">
    <a href="#top" class="brand">THE TIN SPOON<small>CHEF RECIPE KITS</small></a>
    <button class="burger" id="burger" aria-label="Menu">&#9776;</button>
    <nav id="nav">
      <a href="#new">This week</a>
      <a href="#shop">Kits</a>
      <a href="#edits">Menus</a>
      <a href="#reviews">Reviews</a>
      <a href="#help">Help</a>
    </nav>
    <button class="cartbtn" id="openCart">Box <span class="count" id="count">0</span></button>
  </div>
</header>
...
<div class="hero">
  <div class="hero-copy">
    <p class="eyebrow">MENU CHANGES EVERY TUESDAY</p>
    <h1>Coastal kitchens,<br>your <em>stove</em>.</h1>
    <p>Most of our recipes come from kitchens within an hour of the water. Weighed to the gram, written the way the chef runs it, and packed cold enough to survive the drive south.</p>
    <div class="hero-cta">
      <a href="#shop" class="btn btn-solid">See this week's kits</a>
      <a href="#help" class="btn btn-line">How it works</a>
    </div>
  </div>
  <div class="hero-art" id="heroArt">
    <div class="pricetag"><i>KITS FROM</i><b>$29</b></div>
  </div>
</div>

<section id="new">
  <div class="shell">
    <div class="sec-head"><h2>On the menu</h2><p>New list every Tuesday</p></div>
...
<section id="shop" style="padding-top:0">
  <div class="shell">
    <div class="sec-head"><h2>All kits</h2><p><span id="shownCount">0</span> kits</p></div>
    <div class="chips" id="chips"><button class="chip on" data-f="all">Everything</button><button class="chip" data-f="Pasta">Pasta</button><button class="chip" data-f="Mains">Mains</button><button class="chip" data-f="Starters">Starters</button><button class="chip" data-f="Sweets">Sweets</button><button class="chip" data-f="Weeknight">Weeknight</button><button class="chip" data-f="Feeds Four">Feeds Four</button></div>
...
<section id="edits" style="padding-top:0">
  <div class="shell">
    <div class="sec-head"><h2>Build a menu</h2><p>Three courses, one box</p></div>
    <div class="edits" id="editRow"></div>
  </div>
</section>

<section class="promise">
  <div class="shell"><div class="promise-grid"><div><b>Free delivery over $70</b><p>Chilled overnight in an insulated liner with gel packs.</p></div><div><b>Weighed, not guessed</b><p>Every component portioned and labelled before it ships.</p></div><div><b>Local kitchens</b><p>Recipes licensed from chefs along the Maine and New England coast.</p></div><div><b>Call the kitchen</b><p>Mon&ndash;Sat, 8 AM &ndash; 5 PM ET at (207) 555-0126.</p></div></div></div>
</section>

<section id="reviews">
  <div class="shell">
    <div class="sec-head"><h2>What buyers say</h2><p>4.8 average across 2,840 boxes</p></div>
    <div class="reviews"><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>The brown butter kit finally explained when to pull the pan. I have made it five times now without a single scorched batch.</p><b>Ned H.</b><i>Verified buyer &mdash; Burlington, VT</i></div><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>Six boxes, all arrived cold, nothing missing. The liners get reused for our own grocery runs.</p><b>Colleen S.</b><i>Verified buyer &mdash; Manchester, NH</i></div><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9734;</div><p>Great kits. The 'feeds four' is honest with a starter, lighter without one. Order accordingly.</p><b>Marco P.</b><i>Verified buyer &mdash; Worcester, MA</i></div></div>
  </div>
</section>

<section id="help" class="info" style="padding-bottom:70px">
  <div class="shell">
    <div class="sec-head"><h2>Before you order</h2><p>Delivery, allergens, storage</p></div>
    <details open><summary>How the kits work</summary><div class="body"><p>Each box holds weighed dry goods, a chilled pack where needed, and a laminated method card from the chef whose dish it is.</p><p>Most kits take 30&ndash;50 minutes. Anything needing special equipment says so before you buy.</p><table><tr><th>Size</th><th>Serves</th><th>Active time</th></tr><tr><td>Weeknight</td><td>2</td><td>25&ndash;35 min</td></tr><tr><td>Family</td><td>4</td><td>35&ndash;50 min</td></tr><tr><td>Table</td><td>8</td><td>55&ndash;75 min</td></tr></table></div></details><details><summary>Delivery and storage</summary><div class="body"><p>Free over $70, otherwise a flat $10.25 for chilled overnight. We ship Monday to Thursday only.</p><p>Refrigerate the chilled pack on arrival and cook within four days. Dry components keep 30 days.</p><p>Lower 48 only.</p></div></details><details><summary>Allergens and swaps</summary><div class="body"><p>Allergens are printed on the product page and the box. Our packing room handles wheat, dairy, eggs, tree nuts, soy, shellfish and sesame.</p><p>Gluten-free and dairy-free swaps exist on about half the range at no extra charge.</p><ul><li>Warm or damaged boxes refunded same day.</li><li>Unopened dry kits return within 14 days.</li><li>Chilled kits cannot be returned once delivered.</li></ul></div></details>
    <details>
      ...
      <div class="body">
        ...
        <p>Two codes are live right now: <b>SPOON10</b> takes 10% off any order, and <b>SPOON15</b> takes 15% off orders over $75. One code per order.</p>
      </div>
    </details>
    <details>
      ...
      <div class="body">
        ...
        <p>Prices, promotions and availability may change without notice. Screen calibration can shift how colors appear. Placing an order means you accept these terms and the policies above. Any dispute is governed by the laws of the State of Maine.</p>
        <p>Questions about your data: privacy@thetinspoon.example, from the email used on your order.</p>
      </div>
    </details>
    <details>
      <summary>Contact us</summary>
      <div class="body">
        <p><b>Tin Spoon Kitchen LLC</b><br>84 Commercial St, Suite 3<br>Portland, ME 04101, United States</p>
        <p>Phone: (207) 555-0126 &nbsp;&middot;&nbsp; Mon&ndash;Sat, 8 AM &ndash; 5 PM ET<br>Email: hello@thetinspoon.example</p>
      </div>
    </details>
  </div>
</section>
...
<footer>
  <div class="shell">
    <div class="fgrid">
      <div>
        <div class="brand">THE TIN SPOON<small>CHEF RECIPE KITS</small></div>
        <address>Tin Spoon Kitchen LLC<br>84 Commercial St, Suite 3<br>Portland, ME 04101, United States<br>(207) 555-0126</address>
      </div>
      <div>
        <h4>KITS</h4>
        <ul>
          <li><a href="#new">This week</a></li>
          <li><a href="#shop">Kits</a></li>
          <li><a href="#edits">Menus</a></li>
    ...
    <div class="legal">
      <span>&copy; 2026 Tin Spoon Kitchen LLC. All rights reserved.</span>
...
<aside class="drawer" id="drawer" aria-label="Box">
  <div class="dhead">
    <h3 id="drawerTitle">Your box</h3>
  ...
  <div class="dfoot" id="bagFoot">
    ...
    <div class="tot"><span>Delivery</span><span id="shipCost">&mdash;</span></div>
  ...
  <div class="pane" id="paneForm">
    <a class="back" id="backToBag" href="#">&larr; Back to box</a>
    <div class="two">
    ...
    <div class="three">
      ...
      <div class="field"><label for="f-zip">ZIP</label><input id="f-zip" inputmode="numeric" placeholder="04101" autocomplete="postal-code"><span class="err">5 digits</span></div>
    </div>
    ...
    <div class="tot"><span>Delivery</span><span id="c-ship">&mdash;</span></div>
  ...
  <div class="pane" id="paneDone">
    <div class="done-box">
      ...
      <p>Your box ships chilled. Tracking follows tonight by email.</p>
      <div class="oid" id="orderId">TS-000000</div>
...
var CFG = {"prefix": "TS", "code10": "SPOON10", "code15": "SPOON15", "imgs": ["photo-1565299624946-b28f40a0ae38", "photo-1473093295043-cdd812d0e601", "photo-1498579150354-977475b7ea0b", "photo-1600803907087-f56d462fd26b", "photo-1616299915952-04c803388e5f", "photo-1556761223-4c4282c73f77", "photo-1532117472055-4d0734b51f31", "photo-1506280754576-f6fa8a873550", "photo-1516100882582-96c3a05fe590", "photo-1414235077428-338989a2e8c0", "photo-1563379926898-05f4575a45d8", "photo-1598023696416-0193a0bcd302", "photo-1532939624-3af1308db9a5", "photo-1592417817098-8fd3d9eb14a5", "photo-1571167366136-b57e07761625"], "freeShip": 70, "flatShip": 10.25, "freeMsg": "free delivery", "options": ["Weeknight", "Family", "Table"], "optionLabel": "Serves", "bagLc": "box", "browseBtn": "Browse kits", "checkoutTitle": "Delivery details", "doneVerb": "shipping to", "edits": [{"label": "Pasta Night", "pid": "T01", "filter": "Pasta"}, {"label": "Slow Sunday", "pid": "T04", "filter": "Mains"}, {"label": "Dessert First", "pid": "T06", "filter": "Sweets"}], "products": [{"id": "T01", "name": "Brown Butter Tagliatelle Kit", "cat": "Pasta", "tags": ["Weeknight"], "price": 31, "msrp": 52, "shape": "ramen", "print": "solid", "main": ["#b4823a", "#f0e0c0", "#f6efdf"], "alt": ["#2a5c7a", "#d2e2ee", "#e8eff4"], "tag": "THIS WEEK", "fresh": true}, {"id": "T02", "name": "Blistered Green Bean Kit", "cat": "Starters", "tags": ["Weeknight"], "price": 27, "msrp": 45, "shape": "saladbowl", "print": "solid", "main": ["#4f7a3c", "#dfead6", "#edf1e8"], "alt": ["#b4823a", "#f0e0c0", "#f6efdf"], "tag": "THIS WEEK", "fresh": true}, {"id": "T03", "name": "Skillet Flatbread Kit", "cat": "Starters", "tags": ["Feeds Four"], "price": 31, "msrp": 52, "shape": "pizza", "print": "solid", "main": ["#e0b878", "#f4e6cb", "#f5efe3"], "alt": ["#c04a2c", "#f2d3c6", "#f6eae4"], "tag": "THIS WEEK", "fresh": true}, {"id": "T04", "name": "Cider Braised Chicken Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 55, "msrp": 90, "shape": "steakplate", "print": "solid", "main": ["#a8763c", "#e8cfa8", "#f4ede2"], "alt": ["#3a3632", "#c9c2ba", "#eeecea"], "tag": "THIS WEEK", "fresh": true}, {"id": "T05", "name": "Cacio e Pepe Kit", "cat": "Pasta", "tags": ["Weeknight"], "price": 28, "msrp": 46, "shape": "ramen", "print": "solid", "main": ["#c9902a", "#f2e2bc", "#f6efdd"], "alt": ["#2a5c7a", "#d2e2ee", "#e8eff4"], "tag": "", "fresh": false}, {"id": "T06", "name": "Maple Custard Tart Kit", "cat": "Sweets", "tags": [], "price": 29, "msrp": 48, "shape": "dessert", "print": "solid", "main": ["#b4823a", "#f0e0c0", "#f6efdf"], "alt": ["#4a2f24", "#d6c0b2", "#f0eae6"], "tag": "", "fresh": false}, {"id": "T07", "name": "Griddle Burger Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 44, "msrp": 72, "shape": "burger", "print": "solid", "main": ["#c98a3c", "#f2dfc2", "#f5eee2"], "alt": ["#8a4a20", "#e8cdb2", "#f4ebdf"], "tag": "LOW STOCK", "fresh": false}, {"id": "T08", "name": "Potato and Leek Pizza Kit", "cat": "Starters", "tags": ["Feeds Four"], "price": 35, "msrp": 58, "shape": "pizza", "print": "solid", "main": ["#e6d8b8", "#f6efdc", "#f6f1e4"], "alt": ["#4f7a3c", "#dfead6", "#edf1e8"], "tag": "", "fresh": false}, {"id": "T09", "name": "Shaved Apple Salad Kit", "cat": "Starters", "tags": ["Weeknight"], "price": 27, "msrp": 45, "shape": "saladbowl", "print": "solid", "main": ["#7a8f3c", "#e6edcf", "#f0f2e6"], "alt": ["#2a5c7a", "#d2e2ee", "#e8eff4"], "tag": "", "fresh": false}, {"id": "T10", "name": "Blueberry Crumble Kit", "cat": "Sweets", "tags": [], "price": 28, "msrp": 48, "shape": "dessert", "print": "solid", "main": ["#3a4a7a", "#d4dbee", "#eaecf4"], "alt": ["#b4823a", "#f0e0c0", "#f6efdf"], "tag": "", "fresh": false}, {"id": "T11", "name": "Chowder Night Kit", "cat": "Mains", "tags": ["Weeknight"], "price": 36, "msrp": 60, "shape": "ramen", "print": "solid", "main": ["#e6e2d6", "#f4f2e8", "#f4f2ec"], "alt": ["#2a5c7a", "#d2e2ee", "#e8eff4"], "tag": "", "fresh": false}, {"id": "T12", "name": "Slow Roast Pork Shoulder Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 59, "msrp": 96, "shape": "steakplate", "print": "solid", "main": ["#8a5a2a", "#ecd4b8", "#f4ece2"], "alt": ["#4f7a3c", "#dfead6", "#edf1e8"], "tag": "", "fresh": false}]};
